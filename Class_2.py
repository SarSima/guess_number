class Employee:
    ...
    def __generate_employee_id(self,first_name, second_name, gender) -> int:
        employee_id = hash(first_name +  second_name + gender)
        return employee_id
...
empolye_1 = Employee('Иван', 'Иванов', 'м')
print(empolye_1._Employee__generate_employee_id('Иван', 'Иванов', 'м'))
